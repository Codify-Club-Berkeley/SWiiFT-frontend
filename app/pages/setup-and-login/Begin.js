...
export default function Login({navigation}) {
  ...
  return (
    <View style={styles.container}>
            ...
            <Text style={styles.bigText}>my <Text style={styles.bigTextColor}>adventure</Text></Text> 
            <Text style={styles.thirdLine}>as a...</Text>
            <Image style={styles.image} source={require('../../assets/swiiftPictureLogo.png')} resizeMode = "contain" />
